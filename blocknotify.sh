...
# Set to the ip/port of the bitbalancer server:
serverAddress='0.0.0.0'
serverPort=8332

# Set to the "name" property within the bitbalancer's server.json configuration for this node:
nodeName='node-00'

# (Optional)
# Set to the configured IP of the node; must match the node's host within the bitbalancer's server.json configuration for this node:
# nodeIp='0.0.0.0'
